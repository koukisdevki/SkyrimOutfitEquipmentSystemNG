...
namespace HookingPREAE {
    ...
    namespace FixSkillLeveling {
        ...
        REL::RelocationID GetSkillToLevel_Hook_ID = GetHookRelocationID(HookID::GetSkillToLevelHookID);
        std::uintptr_t GetSkillToLevel_Hook(GetSkillToLevel_Hook_ID.address() + 0x52);

        REL::RelocationID BipedAnim_VisitGetWornArmorTypeVisitor = GetHookRelocationID(HookID::BipedAnimVisitGetWornArmorTypeVisitorHookID);

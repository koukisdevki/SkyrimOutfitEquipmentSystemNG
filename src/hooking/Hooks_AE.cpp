...
namespace HookingAE {
    ...
    namespace DontVanillaSkinPlayer {
        ...
        REL::RelocationID DontVanillaSkinPlayer_Hook_ID = GetHookRelocationID(HookID::DontVanillaSkinPlayerHookID); 
        std::uintptr_t DontVanillaSkinPlayer_Hook(DontVanillaSkinPlayer_Hook_ID.address() + 0x302);

        REL::RelocationID TESObjectARMO_ApplyArmorAddon = GetHookRelocationID(HookID::TESObjectARMOApplyArmorAddonHookID);
    ...
    namespace ShimWornFlags {
        ...
        REL::RelocationID ShimWornFlags_Hook_ID = GetHookRelocationID(HookID::ShimWornFlagsHookID);
        std::uintptr_t ShimWornFlags_Hook(ShimWornFlags_Hook_ID.address() + 0x80);// 0x00362F0C in 1.5.73

        REL::RelocationID InventoryChanges_GetWornMask = GetHookRelocationID(HookID::InventoryChangesGetWornMaskHookID);
    ...
    namespace CustomSkinPlayer {
        ...
        REL::RelocationID CustomSkinPlayer_Hook_ID = GetHookRelocationID(HookID::CustomSkinPlayerHookID);
        std::uintptr_t CustomSkinPlayer_Hook(CustomSkinPlayer_Hook_ID.address() + 0x1EF);// 0x00364301 in 1.5.73

        REL::RelocationID InventoryChanges_ExecuteVisitorOnWorn = GetHookRelocationID(HookID::InventoryChangesExecuteVisitorOnWornHookID);
    ...
    namespace FixEquipConflictCheck {
        ...
        REL::RelocationID FixEquipConflictCheck_Hook_ID = GetHookRelocationID(HookID::FixEquipConflictCheckHookID);
        std::uintptr_t FixEquipConflictCheck_Hook(FixEquipConflictCheck_Hook_ID.address() + 0x97);// 0x0060CAC7 in 1.5.73

        REL::RelocationID BGSBipedObjectForm_TestBodyPartByIndex = GetHookRelocationID(HookID::BGSBipedObjectFormTestBodyPartByIndexHookID);
    ...
    namespace FixSkillLeveling {
        ...
        REL::RelocationID SkillMutationFunction_Hook_ID = GetHookRelocationID(HookID::SkillMutationFunctionHookID);
        std::uintptr_t SkillMutationFunction_Hook(SkillMutationFunction_Hook_ID.address() + 0x373);

        REL::RelocationID BipedAnim_GetActorRaceBodyArmorPtrPtr = GetHookRelocationID(HookID::BipedAnimGetActorRaceBodyArmorPtrPtrHookID);
